...
import { models as codexFallbackModels } from "@theagentcompany/adapter-codex-local";
import { models as cursorFallbackModels } from "@theagentcompany/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@theagentcompany/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.TAC_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.TAC_OPENCODE_COMMAND = "__tac_missing_opencode_command__";
