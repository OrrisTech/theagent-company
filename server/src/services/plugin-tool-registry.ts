...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@theagentcompany/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: TacPluginManifestV1, pluginDbId?: string): void;
