/**
 * PluginEventBus — typed in-process event bus for the TAC plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@theagentcompany/shared";
import type { PluginEvent, EventFilter } from "@theagentcompany/plugin-sdk";
