...
import { agents as agentsTable, companies, heartbeatRuns } from "@theagentcompany/db";
...
import { runClaudeLogin } from "@theagentcompany/adapter-claude-local/server";
import {
...
import { ensureOpenCodeModelConfiguredAndAvailable } from "@theagentcompany/adapter-opencode-local/server";
...
export function agentRoutes(db: Db) {
  ...
  const strictSecretsMode = process.env.TAC_SECRETS_STRICT_MODE === "true";
