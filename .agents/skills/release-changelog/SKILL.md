...
description: >
  Generate the stable The Agent Company release changelog at releases/vYYYY.MDD.P.md by
  reading commits, changesets, and merged PR context since the last stable tag.
---

# Release Changelog Skill

Generate the user-facing changelog for the **stable** The Agent Company release.

## Versioning Model

The Agent Company uses **calendar versioning (calver)**:
...
```
- **Feature name** — Description. ([#123](https://github.com/theagentcompany/theagentcompany/pull/123), @contributor1, @contributor2)
```
