...
name: release
description: >
  Coordinate a full The Agent Company release across engineering verification, npm,
...
Run the full The Agent Company maintainer release workflow, not just an npm publish.
...
7. If running through The Agent Company, you have issue context for status updates and follow-up task creation.
...
The Agent Company now uses a commit-driven release model:
...
npm view theagentcompany@canary version
```
...
- release summary in The Agent Company issue context
