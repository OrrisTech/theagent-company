...
import type { PluginCategory, PluginStatus, TacPluginManifestV1 } from "@theagentcompany/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<TacPluginManifestV1>().notNull(),
