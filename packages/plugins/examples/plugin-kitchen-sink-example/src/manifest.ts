...
const manifest: TacPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current TAC plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the TAC domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
