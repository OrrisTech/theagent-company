import type { PluginLauncherRegistration } from "@theagentcompany/plugin-sdk";

export const PLUGIN_ID = "tac-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".tac-kitchen-sink-demo.txt",
} as const;
