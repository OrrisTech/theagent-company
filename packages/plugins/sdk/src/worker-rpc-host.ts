...
import type { TacPluginManifestV1 } from "@theagentcompany/shared";

import type { TacPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@theagentcompany/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: TacPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@theagentcompany/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
