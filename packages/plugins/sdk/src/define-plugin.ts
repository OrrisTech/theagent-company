/**
 * `definePlugin` — the top-level helper for authoring a TAC plugin.
 *
...
// ---------------------------------------------------------------------------
// TacPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 * @returns A sealed `TacPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@theagentcompany/plugin-sdk";
