/**
 * `@theagentcompany/plugin-sdk/ui` — TAC plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@theagentcompany/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@theagentcompany/plugin-sdk/ui";
 *
