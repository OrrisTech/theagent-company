 ...
 *
 * These components are exported from `@theagentcompany/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@theagentcompany/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function TacSdkUiComponent(props: TProps) {
