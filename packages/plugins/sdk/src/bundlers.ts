/**
 * Bundling presets for TAC plugins.
 *
 ...
 * to match the TAC plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@theagentcompany/plugin-sdk/ui",
    "@theagentcompany/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
  ...
  const rollupManifest: RollupLikeConfig = {
    ...
    external: ["@theagentcompany/plugin-sdk"],
  };
