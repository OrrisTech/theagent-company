...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within TacPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the TAC host.
 *
...
export interface TacPluginManifestV1 {
   ...
   */
  minimumTacVersion?: PluginMinimumHostVersion;
