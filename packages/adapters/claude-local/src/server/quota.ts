...
import type { ProviderQuotaResult, QuotaWindow } from "@theagentcompany/adapter-utils";
    ...
    return {
      ...
      error:
        errors.length > 0
          ...
          : `${authDescription}, but The Agent Company could not load subscription quota data`,
      windows: [],
    };
  }
