...
> 目标用户：一般商业团队（非纯技术团队），用来管理 AI agent 团队运营公司/项目
...
**一句话**：给商业团队用的 AI agent 管理平台 — 像管公司一样管 AI 团队。

- 不需要懂命令行
- 看板式任务管理，一目了然
- 统一的 Team Member 模型，不再区分"Paperclip agent"和"OpenClaw agent"
- 完整的 OpenClaw 配置和监控，不用切到终端
- 多语言、可换品牌、light/dark 主题
- 5 个预制工作流模板：内容创作、广告策略、SEO 审计、竞品分析、客户跟进
- 三维绩效评估：效率指标 + 质量指标（交叉验证）+ 协作指标
