...
The Agent Company supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying The Agent Company?** Use `local_trusted` (the default)
