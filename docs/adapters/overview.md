...
summary: What adapters are and how they connect agents to The Agent Company
---

Adapters are the bridge between The Agent Company's orchestration layer and agent runtimes. Each adapter knows how to invoke a specific type of AI agent and capture its results.

## How Adapters Work

When a heartbeat fires, The Agent Company:
...
packages/adapters/<name>/
  src/
    ...
    cli/
      format-event.ts   # Terminal output for `theagentcompany run --watch`
```
