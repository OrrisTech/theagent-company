...
Manage companies within your TAC instance.
...
Company logo uploads use the normal The Agent Company attachment size limit.
...
| `logoUrl` | string | Optional The Agent Company asset content path for the stored logo image |
