...
The Agent Company tracks every token spent by every agent and enforces budget limits to prevent runaway costs.
...
The Agent Company enforces budgets automatically:
