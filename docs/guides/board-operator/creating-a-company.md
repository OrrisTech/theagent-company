...
A company is the top-level unit in The Agent Company. Everything — agents, tasks, goals, budgets — lives under a company.
...
Set monthly budgets at both the company and per-agent level. The Agent Company enforces:
