...
- Primary: PostgreSQL
- Local default: embedded PostgreSQL at `~/.theagentcompany/instances/default/db`
- Optional local prod-like: Docker Postgres
- Optional hosted: Supabase/Postgres-compatible
- File/object storage:
  - local default: `~/.theagentcompany/instances/default/data/storage` (`local_disk`)
...
- exactly one JSON entrypoint: `theagentcompany.manifest.json`
