...
- installed adapter list for this TAC instance
...
## 8. New Skill: `tac-create-agent`

Create new skill directory:

- `skills/tac-create-agent/SKILL.md`
...
Also update `skills/tac/SKILL.md` to reference this skill for hiring workflows.
...
- `tac-create-agent` skill + docs updates
