...
This is intentionally separate from the normal The Agent Company dev image.
...
```sh
review-checkout-pr theagentcompany/theagentcompany 432
cd /work/checkouts/theagentcompany-theagentcompany/pr-432
```
...
## Preview the TAC app from the PR
...
- The Agent Company's embedded PostgreSQL and local storage stay inside the container home volume via `TAC_HOME=/home/reviewer/.theagentcompany-review`.
