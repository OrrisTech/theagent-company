...
This document covers the GitHub and npm setup required for the current The Agent Company release model:
...
Do this for every public package that The Agent Company publishes.
...
3. add a trusted publisher for the GitHub repository `theagentcompany/theagentcompany`
...
2. revoke any personal automation token that used to publish The Agent Company
