...
Low-level reference for how The Agent Company packages are prepared and published to npm.
...
The Agent Company no longer uses release branches or Changesets for publishing.

## Why the CLI needs special packaging

The CLI package, `theagentcompany`, imports code from workspace packages such as:
...
The Agent Company uses calendar versions:
...
- `theagentcompany@2026.318.1-canary.2`
