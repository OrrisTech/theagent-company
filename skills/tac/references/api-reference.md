...
Detailed reference for the TAC control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "The Agent Company Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "theagentcompany-mobile",
    "cwd": "/Users/me/theagentcompany-mobile",
    "repoUrl": "https://github.com/acme/theagentcompany-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `tac-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
