    ...
    <div>
      ...
      {runs.length === 0 ? (
        <div className="rounded-xl border border-border p-4">
          <p className="text-sm text-muted-foreground">{t("activeAgentsPanel.noRecentAgentRuns")}</p>
        </div>
      ) : (
    ...
    <div className={cn(
      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-3">
        <RunTranscriptView
          ...
          emptyMessage={hasOutput ? t("activeAgentsPanelExtra.waitingForTranscriptParsing") : isActive ? t("activeAgentsPanelExtra.waitingForOutput") : t("activeAgentsPanelExtra.noTranscriptCaptured")}
        />
      </div>
    </div>
  );
