...
// Status labels are resolved via t() inside components - see getStatusLabel()
...
export function IssueStatusChart({ issues }: { issues: { status: string; createdAt: Date }[] }) {
  ...
  return (
    <div>
      ...
      <DateLabels days={days} />
      <ChartLegend items={statusOrder.map(s => ({ color: statusColors[s] ?? "#6b7280", label: ({
        todo: t("activityCharts.toDo"),
        in_progress: t("activityCharts.inProgress"),
        in_review: t("activityCharts.inReview"),
        done: t("activityCharts.done"),
        blocked: t("activityCharts.blocked"),
        cancelled: t("activityCharts.cancelled"),
        backlog: t("activityCharts.backlog"),
