  ...
  return (
    <div>
      <div className="space-y-1 pb-4">
        <PropertyRow label={<FieldLabel label={t("teamMember.identity.name")} state={fieldState("name")} />}>
        ...
        <PropertyRow
          label={<FieldLabel label={t("pages.workflows.workflowDescription")} state={fieldState("description")} />}
          alignStart
        ...
        <PropertyRow label={<FieldLabel label={t("pages.workflows.status")} state={fieldState("status")} />}>
          {onUpdate || onFieldUpdate ? (
            <ProjectStatusPicker
        ...
        <PropertyRow
          label={<FieldLabel label={t("sidebar.goals")} state={fieldState("goals")} />}
          alignStart
          ...
          <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
            ...
            <Tooltip>
              ...
              <TooltipContent side="top">
                {t("projectProperties.repoIdentifiesTheSourceOfTruthLocalFolderIsTheDefa")}
              </TooltipContent>
            </Tooltip>
          </div>
          <div className="space-y-2 rounded-md border border-border/70 p-3">
            ...
            {hasAdditionalLegacyWorkspaces && (
              <div className="text-[11px] text-muted-foreground">
                {t("projectProperties.additionalLegacyWorkspaceRecordsExistOnThisProject")}
              </div>
            )}
            ...
            <div className="py-1.5 space-y-2">
              <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                ...
                <Tooltip>
                  ...
                  <TooltipContent side="top">
                    {t("projectProperties.projectOwnedDefaultsForIsolatedIssueCheckoutsAndEx")}
                  </TooltipContent>
                </Tooltip>
              </div>
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="space-y-0.5">
                    <div className="flex items-center gap-2 text-sm font-medium">
                      <span>{t("projectProperties.enableIsolatedIssueCheckouts")}</span>
                      <SaveIndicator state={fieldState("execution_workspace_enabled")} />
                    </div>
                    <div className="text-xs text-muted-foreground">
                      {t("projectProperties.letIssuesChooseBetweenTheProjectSPrimaryCheckoutAn")}
                    </div>
                  </div>
                  {onUpdate || onFieldUpdate ? (
                    <button
                ...
                {executionWorkspacesEnabled ? (
                  <div className="space-y-3">
                    <div className="flex items-center justify-between gap-3">
                      <div className="space-y-0.5">
                        <div className="flex items-center gap-2 text-sm">
                          <span>{t("projectProperties.newIssuesDefaultToIsolatedCheckout")}</span>
                          <SaveIndicator state={fieldState("execution_workspace_default_mode")} />
                        </div>
                        <div className="text-[11px] text-muted-foreground">
                          {t("projectProperties.ifDisabledNewIssuesStayOnTheProjectSPrimaryCheckou")}
                        </div>
                      </div>
                      <button
                        className={cn(
                    ...
                    {executionWorkspaceAdvancedOpen ? (
                      <div className="space-y-3">
                        <div className="text-xs text-muted-foreground">
                          Host-managed implementation: <span className="text-foreground">{t("projectProperties.gitWorktree")}</span>
                        </div>
                        <div>
