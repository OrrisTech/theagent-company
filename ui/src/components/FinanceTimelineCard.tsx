import type { FinanceEvent } from "@theagentcompany/shared";
  ...
  return (
    <Card>
      <CardHeader className="px-4 pt-4 pb-1">
        <CardTitle className="text-base">{t("financeTimelineCard.recentFinancialEvents")}</CardTitle>
        <CardDescription>{t("financeTimelineCard.topUpsFeesCreditsCommitmentsAndOtherNonRequestChar")}</CardDescription>
      </CardHeader>
