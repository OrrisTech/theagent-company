...
import type { Goal } from "@theagentcompany/shared";
import { GOAL_STATUSES, GOAL_LEVELS } from "@theagentcompany/shared";
      ...
      <div className="space-y-1">
        ...
        <PropertyRow label={t("goalProperties.owner")}>
          {ownerAgent ? (
            ...
            <span className="text-sm text-muted-foreground">{t("pluginSettings.none")}</span>
          )}
        </PropertyRow>
