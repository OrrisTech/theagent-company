...
export function EventHorizonShader() {
  ...
  useEffect(() => {
    ...
    const onLoad = () => {
      ...
      if (!win) return;
      // Position black hole to the right and slightly up, scaled up
      win.postMessage({ type: "param", name: "BH_CENTER_X", value: 0.5 }, "*");
      win.postMessage({ type: "param", name: "BH_CENTER_Y", value: 0.5 }, "*");
      win.postMessage({ type: "param", name: "BH_SCALE", value: 1.8 }, "*");
    };
