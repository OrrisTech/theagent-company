 ...
 *
 * This is placed on `globalThis.__tacPluginBridge__` and consumed by
...
declare global {
  ...
  var __tacPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__tacPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__tacPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
