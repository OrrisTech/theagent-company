  ...
  return (
    <div className="max-w-2xl space-y-4">
      <div className="space-y-1">
        <div className="text-xs text-muted-foreground">{t("newIssueDialog.executionWorkspace")}</div>
      ...
      <div className="rounded-lg border border-border p-4">
        <DetailRow label={t("usage.project")}>
        ...
        <DetailRow label={t("executionWorkspaceDetail.branch")}>{workspace.branchName ?? "None"}</DetailRow>
        <DetailRow label={t("projectProperties.baseRef")}>{workspace.baseRef ?? "None"}</DetailRow>
        ...
        <DetailRow label={t("newProjectDialog.repoUrl")}>
        ...
        <DetailRow label={t("executionWorkspaceDetail.opened")}>{new Date(workspace.openedAt).toLocaleString()}</DetailRow>
        <DetailRow label={t("executionWorkspaceDetail.lastUsed")}>{new Date(workspace.lastUsedAt).toLocaleString()}</DetailRow>
