...
export function AuthPage() {
  ...
  return (
    <div className="fixed inset-0">
      ...
      {/* Left half — form with gradient fade into shader */}
      <div className="relative z-10 flex min-h-full">
        <div className="w-full md:w-1/2 flex flex-col overflow-y-auto bg-background">
        ...
        {/* Gradient fade from bg-background into transparent, overlaying the shader edge */}
        <div className="hidden md:block w-32 shrink-0 bg-gradient-to-r from-background to-transparent pointer-events-none" />
      </div>
    </div>
  );
}
