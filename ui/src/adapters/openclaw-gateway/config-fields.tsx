...
export function OpenClawGatewayConfigFields({
  ...
  return (
    <>
      <Field label={t("adapterConfig.gatewayUrl")} hint={help.webhookUrl}>
        <DraftInput
          value={
            isCreate
              ? values!.url
      ...
      {!isCreate && (
        <>
          <Field label={t("adapterConfig.apiUrlOverride")}>
            <DraftInput
              value={
                eff(
                  "adapterConfig",
          ...
          <Field label={t("adapterConfig.sessionStrategy")}>
            <select
            ...
            >
              ...
              <option value="issue">{t("adapterConfig.perIssue")}</option>
              <option value="run">{t("adapterConfig.perRun")}</option>
            </select>
          </Field>
          ...
          <SecretField
            label={t("adapterConfig.gatewayAuthToken")}
            value={effectiveGatewayToken}
            onCommit={commitGatewayToken}
            placeholder={t("adapterConfig.gatewayTokenPlaceholder")}
          />

          <Field label={t("adapterConfig.role")}>
            <DraftInput
          ...
          <Field label={t("adapterConfig.scopesCommaSeparated")}>
            <DraftInput
          ...
          <Field label={t("adapterConfig.waitTimeoutMs")}>
            <DraftInput
