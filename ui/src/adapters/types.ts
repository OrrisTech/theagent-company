...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@theagentcompany/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@theagentcompany/adapter-utils").TranscriptEntry[];
